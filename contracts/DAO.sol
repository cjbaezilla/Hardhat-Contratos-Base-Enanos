...
contract DAO is Ownable {
    ...
    uint256 public MIN_PROPOSAL_VOTES = 10; // Mínimo 10 NFTs para crear propuesta
    uint256 public MIN_VOTES_TO_APPROVE = 10; // Mínimo 5 votantes únicos para aprobar propuesta
    uint256 public MIN_TOKENS_TO_APPROVE = 50; // Mínimo 50 tokens de poder de voto total para aprobar propuesta
    
    mapping(uint256 => Proposal) public proposals;
    mapping(uint256 => mapping(address => bool)) public hasVoted;
    mapping(uint256 => uint256) public proposalUniqueVotersCount; // Cantidad de usuarios únicos que votaron por propuesta
    mapping(uint256 => uint256) public proposalTotalVotingPowerSum; // Suma total del poder de voto de cada propuesta
     ...
     * @param username Nombre de usuario del proposer
     * @param description Descripción de la propuesta
     * @param link Enlace relacionado con la propuesta
     * @param startTime Tiempo de inicio de la votación
     * @param endTime Tiempo de fin de la votación
     */
    function createProposal(string calldata username, string calldata description, string calldata link, uint256 startTime, uint256 endTime) external {
        ...
        // Prevenir spam: máximo 1 propuesta por dirección cada 24 horas
        require(
            block.timestamp >= lastProposalTime[msg.sender] + 1 days,
            "Solo puedes crear una propuesta cada 24 horas"
        );
        
        // Validar que startTime y endTime sean válidos
    ...
    function vote(uint256 proposalId, bool support) external {
        ...
        proposalUniqueVotersCount[proposalId]++; // Incrementar contador de votantes únicos
        proposalTotalVotingPowerSum[proposalId] += nftBalance; // Incrementar suma total del poder de voto
    ...
    /**
     * @dev Cancela una propuesta (solo el proposer)
     * @param proposalId ID de la propuesta
     */
    ...
    /**
     * @dev Obtiene el poder de voto de una dirección
     * @param voter Dirección del votante
     * @return Cantidad de NFTs (poder de voto)
     */
    ...
    function getProposalStatus(uint256 proposalId) external view returns (string memory) {
        ...
        // Verificar que se cumplan ambos criterios para aprobar:
        // 1. Más votos a favor que en contra
        // 2. Suficientes votantes únicos (MIN_VOTES_TO_APPROVE)
        // 3. Suficiente poder de voto total (MIN_TOKENS_TO_APPROVE)
    ...
    /**
     * @dev Obtiene el total de propuestas creadas
     * @return Cantidad total de propuestas
     */
    ...
    /**
     * @dev Obtiene la cantidad de usuarios únicos que votaron en una propuesta
     * @param proposalId ID de la propuesta
     * @return Cantidad de votantes únicos
     */
    ...
    /**
     * @dev Obtiene la suma total del poder de voto de una propuesta
     * @param proposalId ID de la propuesta
     * @return Suma total del poder de voto
     */
    ...
    /**
     * @dev Actualiza la dirección del contrato NFT
     * @param _newNftContract Nueva dirección del contrato NFT
     */
    ...
    /**
     * @dev Actualiza el mínimo de NFTs requeridos para crear una propuesta
     * @param _newMinProposalVotes Nuevo valor mínimo
     */
    ...
    /**
     * @dev Actualiza el mínimo de votantes únicos requeridos para aprobar una propuesta
     * @param _newMinVotesToApprove Nuevo valor mínimo
     */
    ...
    /**
     * @dev Actualiza el mínimo de tokens de poder de voto total requeridos para aprobar una propuesta
     * @param _newMinTokensToApprove Nuevo valor mínimo
     */

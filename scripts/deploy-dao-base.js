...
async function main() {
  console.log("🚀 Iniciando despliegue del contrato DAO en Base Mainnet...");
  ...
  console.log("- DAO:", `https://basescan.org/address/${daoAddress}`);
  console.log("- NFT:", `https://basescan.org/address/${nftContractAddress}`);
  
  console.log("\n📝 Información para verificación:");
  console.log(`npx hardhat verify --network base ${daoAddress} "${nftContractAddress}"`);
}
